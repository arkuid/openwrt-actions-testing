...
#sed -i 's/^# CONFIG_PACKAGE_libnetfilter-queue is not set$/CONFIG_PACKAGE_libnetfilter-queue=y/; s/^CONFIG_PACKAGE_libnetfilter-queue=m$/CONFIG_PACKAGE_libnetfilter-queue=y/' .config
